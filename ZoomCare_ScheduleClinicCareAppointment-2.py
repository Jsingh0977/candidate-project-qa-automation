#This automated framework validates the workflow of scheduling Clinic care appointments using user's current location
...
element.click()
time.sleep(3)
element = driver.find_element(By.XPATH, "/html/body/div[2]/div/div/div/div/div[2]/div/div[1]/button[1]")
element.click()
time.sleep(3)
...
if driver.find_element(By.CSS_SELECTOR,"div.css-1dbjc4n.r-1awozwy.r-1loqt21.r-18u37iz.r-1777fci.r-10paoce.r-1otgn73.r-1i6wzkk.r-lrvibr"):
    print("Successfully landed at the registration page for scheduling ClinicCare appointment")
